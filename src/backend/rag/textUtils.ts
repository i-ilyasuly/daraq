/**
 * MurmurHash3 32-bit implementation for fast and collision-resistant hashing
 */
...
/**
 * Text-тен Sparse вектор (BM25/TF-IDF) жасауға арналған токенизация функциясы
 */
export function tokenizeAndHash(text: string) {
  ...
  for (const word of words) {
     const hash = murmurhash3_32_gc(word);
